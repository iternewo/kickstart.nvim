...
return {
  {
    ...
    cmd = 'Neogit',
    keys = {
      { '<leader>gg', '<cmd>Neogit<cr>', desc = 'Neo[g]it', { silent = true, noremap = true } },
      { '<leader>gc', ':Neogit commit<CR>', desc = '[C]ommit', { silent = true, noremap = true } },
      { '<leader>gp', ':Neogit pull<CR>', desc = '[P]ull', { silent = true, noremap = true } },
      { '<leader>gP', ':Neogit push<CR>', desc = '[P]ush', { silent = true, noremap = true } },
      { '<leader>gt', ':Telescope git_branches<CR>', desc = '[T]elescope Branches', { silent = true, noremap = true } },
      { '<leader>gb', ':Neogit branch<CR>', desc = '[B]ranch', { silent = true, noremap = true } },
    },
  },
  {
  ...
  -- },
  {
    ...
    keys = {
      ...
      { '<leader>vv', ':w<CR><cmd>LoveRun<cr>', ft = 'lua', desc = 'Run LÖVE' },
